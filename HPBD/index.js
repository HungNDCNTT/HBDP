let  contentLetterSrart_actived = "Happy Bóp ti bạn Gieng Hehe ^-^ \n Ấn vào hình hộp quà nhá!! " //Lời mở đầu cho bức thư
let  mainContentLetter = "Chúc mừng bạn Gieng lần sinh nhật thứ 5 vẫn được anh gửi lời chúc sinh nhật. \n Chúc bạn Gieng luôn mạnh khỏe, siu cấp vip pro \n Chúc bạn Gieng hay ăn chóng nhớn kím thật nhìu $$$$. \n Chúc bạn Gieng năm sau, năm sau nữa và sau sau nữa nữa vẫn được anh chúc mừng sinh nhật hehee ^-^" //Nội dung của bức thư
    ...
    splitContentLetterSrart_actived.forEach((val, index) => {
        setTimeout(() => {
            ...
            if (index == contentLetterSrart_actived.length - 1) {
                setTimeout(() => {
                    document.querySelector(".recieve").setAttribute("style", "opacity: 1; transition: .7s") 
                }, 1000)
            }
        }, 50 * index)
    })
